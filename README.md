...
This source tree contains code suitable for running read processing and scoring of protein occupancy in IPOD data sets using version 2 of the processing pipeline (version 1 is an outgrowth of the methods described in [this paper](https://doi.org/10.1101/2020.01.29.924811)).
